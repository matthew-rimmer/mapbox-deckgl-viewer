...
export const mapDeckViewerSubjectsNames: (keyof MapDeckViewerSubjects)[] = ["$onLumaGlWarning", "$onModelFailedToLoad", "$renderingSceneFinshed", "$testing", "$testingResults"] as const;
